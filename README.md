...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | **Two Sum** | [`Two_SUm.c`](./Leetcode-C/Two_SUm.c) | $O(N^2)$ | $O(1)$ | Brute Force / Double Loop |
| 3 | **Longest Substring Without Repeating Characters** | [`Longest_Substring.c`](./Leetcode-C/Longest_Substring.c) | $O(N^3)$ | $O(1)$ | Brute Force Substring Search |
| 7 | **Reverse Integer** | [`Reverse_Integer.c`](./Leetcode-C/Reverse_Integer.c) | $O(\log_{10} X)$ | $O(1)$ | Digit manipulation with overflow checks |
| 15 | **3Sum** | [`3sum.c`](./Leetcode-C/3sum.c) | $O(N^2)$ | $O(\log N)$ or $O(N)$ | Sorting + Two Pointers |
| 26 | **Remove Duplicates from Sorted Array** | [`Remove_Duplicates.c`](./Leetcode-C/Remove_Duplicates.c) | $O(N)$ | $O(1)$ | Two Pointers (In-place) |
| 44 | **Wildcard Matching** | [`Wildcard_Matching.c`](./Leetcode-C/Wildcard_Matching.c) | $O(N)$ average | $O(1)$ | Greedy Backtracking |
| 75 | **Sort Colors** | [`Sort_Colors.c`](./Leetcode-C/Sort_Colors.c) | $O(N)$ | $O(1)$ | Dutch National Flag Algorithm (3-way partition) |
| 80 | **Remove Duplicates from Sorted Array II** | [`Remove_Duplicates_AsrrayII.c`](./Leetcode-C/Remove_Duplicates_AsrrayII.c) | $O(N)$ | $O(1)$ | Two Pointers (At most 2 occurrences) |
| 202 | **Happy Number** | [`Happy_Number.c`](./Leetcode-C/Happy_Number.c) | $O(\log N)$ | $O(1)$ | Floyd's Cycle-Finding Algorithm |

---

## Technical Details

### Leetcode #1: Two Sum ([`Two_SUm.c`](./Leetcode-C/Two_SUm.c))
...
### Leetcode #3: Longest Substring Without Repeating Characters ([`Longest_Substring.c`](./Leetcode-C/Longest_Substring.c))
...
### Leetcode #7: Reverse Integer ([`Reverse_Integer.c`](./Leetcode-C/Reverse_Integer.c))
...
### Leetcode #15: 3Sum ([`3sum.c`](./Leetcode-C/3sum.c))
...
### Leetcode #26: Remove Duplicates from Sorted Array ([`Remove_Duplicates.c`](./Leetcode-C/Remove_Duplicates.c))
...
### Leetcode #44: Wildcard Matching ([`Wildcard_Matching.c`](./Leetcode-C/Wildcard_Matching.c))
...
### Leetcode #75: Sort Colors ([`Sort_Colors.c`](./Leetcode-C/Sort_Colors.c))
...
### Leetcode #80: Remove Duplicates from Sorted Array II ([`Remove_Duplicates_AsrrayII.c`](./Leetcode-C/Remove_Duplicates_AsrrayII.c))
...
### Leetcode #202: Happy Number ([`Happy_Number.c`](./Leetcode-C/Happy_Number.c))
